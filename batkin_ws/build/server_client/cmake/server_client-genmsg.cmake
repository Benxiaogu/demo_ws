...
get_filename_component(_filename "/home/sundawn/batkin_ws/src/server_client/srv/AddInts.srv" NAME_WE)
add_custom_target(_server_client_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "server_client" "/home/sundawn/batkin_ws/src/server_client/srv/AddInts.srv" ""
)
...
_generate_srv_cpp(server_client
  "/home/sundawn/batkin_ws/src/server_client/srv/AddInts.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/server_client)
  install(CODE "execute_process(COMMAND \"/home/sundawn/anaconda3/envs/ros/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/server_client\")")
  # install generated code
  install(
